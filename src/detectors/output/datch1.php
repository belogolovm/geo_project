...
$res = pg_query($dbconn, "select * from detectors.datch1_{$numb_scv} order by DATE desc limit 1;");
$rash=pg_fetch_result($res, 0, 0);
$temp=pg_fetch_result($res, 0, 1);
$elpr=pg_fetch_result($res, 0, 2);
$gaz=pg_fetch_result($res, 0, 3);
$date1=pg_fetch_result($res, 0, 4);
